...
+ (void) launchProgress {
    ...
    if ([ANUserManager isUserLogin]) {
        config.fileURL = [[[config.fileURL URLByDeletingLastPathComponent]  URLByAppendingPathComponent:[NSString stringWithFormat:@"%@",[ANUserManager userId]]] URLByAppendingPathExtension:@"realm"];
    }
    else
    {
...
//            }
        ...
        if ([ANUserManager isUserLogin]) {
            realConfigure.fileURL = [[[initRealmRootPath URLByDeletingLastPathComponent]  URLByAppendingPathComponent:[NSString stringWithFormat:@"%@",[ANUserManager userId]]] URLByAppendingPathExtension:@"realm"];
        }
        else
        {
