...
- (NSString *) imageUrlPrefix {
    return [[_configurateDictionary objectForKey:_environmentGroupKey] objectForKey:LEImageUrlKey];
}

- (NSString *) sslUrlPrefix {
    return [[_configurateDictionary objectForKey:_environmentGroupKey] objectForKey:LESSLUrlKey];
}
