...
- (void) _setUpPageControl {
 ...
 //self.pageControl.transform=CGAffineTransformScale(CGAffineTransformIdentity, 1.5,1.5);
    ...
    _pageControlBottomConstraint = [NSLayoutConstraint constraintWithItem:self.pageControl attribute:NSLayoutAttributeBottom relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeBottom multiplier:1.0f constant:27.0f];
